...
<section id="home-section" class="hero">
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
    		<div class="row">
				<!-- fetch this item from backend and show product list here -->

				<?php
           $fetchProducts = "SELECT * FROM `products`";
				  $query = mysqli_query($con, $fetchProducts);
				  while($row = mysqli_fetch_assoc($query)){
					?>
					<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="<?php echo '../startbootstrap-sb-admin-2-gh-pages/Products/' . $row['image']; ?>
" alt="Colorlib Template">
    						<span class="status">30% off now</span>
    						<div class="overlay"></div>
    					</a>
                  ...
                  <!-- form -->
									...
									<!-- add to cart icon -->
	    							<button type="submit"  class="buy-now d-flex justify-content-center align-items-center mx-1" name="addToCart">
      ...
      $(document).on('submit', "#myform", function(event){
        ...
        $.ajax({
          ...
          success:function(response){
            if(response === "product alreacy in the cart"){
              Swal.fire({
                    title: 'Item',
                    text: response,
                    icon: 'warning'
